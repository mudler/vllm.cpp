...
| MiniMax-H3 lane | **fl2va COHERENT; ref2va assembly bug FIXED+gated** (`H3-REF2VA-ASSEMBLY`) | +audio-duration fix (#68); grid RE-ATTRIBUTED to the ref2va NVFP4 ckpt/loader (§8.10) |
