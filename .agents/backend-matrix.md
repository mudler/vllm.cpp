...
| `BACKEND-CUDA-COMP-FA` | FlashAttention | FA2 all filtered targets; FA3 >=12.3; FA4 CuTe package; `vllm_flash_attn.cmake:1-46`, `fa_utils.py:132-250` | FA2 BF16 causal head-256 prefill plus bounded ratio-6 non-causal split-KV decode [CMakeLists.txt:428](../CMakeLists.txt#L428), [adapter](../src/vt/cuda/cuda_flash_attn_fa2.cu#L429) | [paged-attention tests](../tests/vt/test_ops_paged_attn.cpp#L585), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L110); immutable `ae9e8ff` clean sm_121a compile/operator/memcheck/model/paired-trace pass, component pending | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md) | `PARTIAL` | - |
