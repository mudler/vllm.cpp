...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; cache lifecycle `kernel_warmup.py:133-213`; model-owned alpha `compressed_tensors_w4a4_nvfp4.py:95-141`, `kernels/linear/nvfp4/flashinfer.py:125-170`; FA2 backend `vllm/v1/attention/backends/flash_attn.py:674-721,935-977` and dependency `flash_api.cpp:262-327,587-714`; [benchmark protocol](benchmark-protocol.md) | [schema-v5 oracle contract and lossless validator](../tools/bench/online_gate.py); [summary](../tools/bench/online_gate_summary.py); [three-session/twelve-report driver](../scripts/dgx-online-serving.sh); [capture-boundary probe](../tools/bench/nsys_cuda_profiler_probe.cu); diagnostic [graceful target stop](../examples/server/main.cpp); W3-G exact [FA2 decode adapter](../src/vt/cuda/cuda_flash_attn_fa2.cu#L429), [dispatch](../src/vt/cuda/cuda_paged_attn.cu#L2501), [model gate](../src/vllm/model_executor/models/qwen3_5.cpp#L2692) | Schema-v5 [per-range validation](../tests/tools/test_online_gate_client.py#L956), [12-report contract](../tests/tools/test_online_gate_client.py#L1472), and [summary fixture](../tests/tools/test_online_gate_summary.py#L286) are CPU-green. Schema-v4 `b9beccd` remains VOID after four complete zero-eager reports. The probe reproduces its exact warning at the pinned profiler-API boundary while the identical full-process trace is clean; schema v5 requires exact version/runtime/synchronization/event/topology/zero-eager/cross-report reconciliation. A fresh immutable 12-report DGX run is pending. `3f256ab` remains **55/124** and 35B performance remains blocked. See [W3-H contract](specs/nvfp4-bf16-producer-vectorization.md) and [benchmark scoreboard](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) | `PARTIAL` | - |
