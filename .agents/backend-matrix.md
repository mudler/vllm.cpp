...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; async default `vllm/config/vllm.py:952-1043`; depth-2 engine path `vllm/v1/engine/core.py:519-607`; async output `vllm/v1/worker/gpu/async_utils.py:12-70`; [benchmark protocol](benchmark-protocol.md) | Existing schema-v5 validator/summary remain. The trace-only [controller](../include/vt/cuda/cuda_profiler_control.h#L13), one-lock packed/rollback [driver](../scripts/dgx-online-serving.sh), mode-keyed [validator](../tools/bench/online_gate.py#L155), and marker-last [packed finalizer](../tools/bench/finalize_gdn_packed_trace.py#L218) preserve historical evidence and enforce explicit B=2 provenance; production builds have no observer | Binding `3f256ab` stays **55/124**. Clean `f344dec` closes packed W1D2/G2 with [27B default/rollback](../tests/parity/test_qwen27_paged_engine.cpp#L125), [CUDA GDN](../tests/vt/test_ops_gdn.cpp#L1039), and 35B/GGUF inertness. Clean `4804ee4` built 154/154, passed the model gate and validated eight packed ranges, then failed/voided on a shared-log marker-prefix race before repetition-3 export, packed-vLLM or rollback. The prefix/cardinality/suffix [driver/parser contract](../tests/tools/test_online_gate_client.py) passes within **82/82**; fresh node traces and c2/c16 remain pending. No speed credit exists; host PSS/RSS remains **22.920 GiB** and 35B performance is blocked | [CUDA inventory](specs/cuda-architecture-inventory.md); [online gate](specs/cuda-online-serving-gate.md); [packed decode](specs/gdn-packed-decode.md); [W3-I](specs/nvfp4-fused-silu-producer.md) | `PARTIAL` | - |
