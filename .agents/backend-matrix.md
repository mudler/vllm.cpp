...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; cache lifecycle `kernel_warmup.py:133-213`; model-owned alpha `compressed_tensors_w4a4_nvfp4.py:95-141`, `kernels/linear/nvfp4/flashinfer.py:125-170`; FA2 backend `vllm/v1/attention/backends/flash_attn.py:674-721,935-977` and dependency `flash_api.cpp:262-327,587-714`; [benchmark protocol](benchmark-protocol.md) | [oracle contract and lossless validator](../tools/bench/online_gate.py); [summary](../tools/bench/online_gate_summary.py); [three-capture driver](../scripts/dgx-online-serving.sh); W3-G exact [FA2 decode adapter](../src/vt/cuda/cuda_flash_attn_fa2.cu#L429), [dispatch](../src/vt/cuda/cuda_paged_attn.cu#L2501), [model gate](../src/vllm/model_executor/models/qwen3_5.cpp#L2692) and [ported tests](../tests/vt/test_ops_paged_attn.cpp#L1354) | W3-E/W3-F/W3-G strict-fail, so `3f256ab` remains **55/124** and W3-G earns no speed credit. W3-H1a/H1b are `VOID`. Immutable `d1f8e33` H1c is also `VOID`: Nsight warned of possible loss after 818,537 events and stopped before r2/r3/vLLM; independently, detached configure SHA `7d510aa4…ed5d` says CUTLASS was not found and disabled. Compile/cache provenance (`a834cfc6…855` / `6a34a146…80de`) plus **146,661 naive + 10,944 WMMA** FP4 calls prove the wrong fallback dispatch. The 19.20-s model gate is fallback correctness only. H1d must preflight the exact CUTLASS tree, `VT_CUTLASS_NVFP4`, binary linkage and runtime kernel family before GPU work, then enforce lossless collection plus exact plan/workload/graph/capture/vLLM semantics. Exact rerun and 35B performance remain blocked. [Trace validator tests](../tests/tools/test_online_gate_client.py#L320) and [indexed summary-artifact test](../tests/tools/test_online_gate_summary.py#L529) cover the earlier contract but not these audited gaps; see [W3-H spike/evidence contract](specs/nvfp4-bf16-producer-vectorization.md) and [BENCHMARKS](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) | `PARTIAL` | - |
