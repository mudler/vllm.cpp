...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; async default `vllm/config/vllm.py:952-1043`; depth-2 engine path `vllm/v1/engine/core.py:519-607`; async output `vllm/v1/worker/gpu/async_utils.py:12-70`; [benchmark protocol](benchmark-protocol.md) | Existing schema-v5 validator/summary remain. The trace-only [controller](../include/vt/cuda/cuda_profiler_control.h#L13), [driver](../scripts/dgx-online-serving.sh#L14), batch-keyed [validator](../tools/bench/online_gate.py#L99), and fail-closed [c2 finalizer](../tools/bench/finalize_low_batch_trace.py#L1) preserve c16 and enforce explicit B=2 evidence; production builds have no observer. Oracle mode remains [profile_vllm_online_gate.py](../tools/bench/profile_vllm_online_gate.py#L21) | Binding `3f256ab` stays **55/124**. FP4 tactics and BA structure/projection are matched. Packed W1D2 is implemented and mutable G2 passes [default+rollback 27B](../tests/parity/test_qwen27_paged_engine.cpp#L125) **235/235**, [CUDA GDN](../tests/vt/test_ops_gdn.cpp#L1039) **43/43**, and [35B native/batched](../tests/parity/test_qwen36_paged_engine.cpp#L116) plus GGUF inertness. Immutable G2 plus paired node traces and c2/c16 remain pending. No speed credit exists; host PSS/RSS remains **22.920 GiB**, W3-I is off and 35B performance blocked | [CUDA inventory](specs/cuda-architecture-inventory.md); [online gate](specs/cuda-online-serving-gate.md); [packed decode](specs/gdn-packed-decode.md); [W3-I](specs/nvfp4-fused-silu-producer.md) | `PARTIAL` | - |
