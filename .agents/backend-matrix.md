...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; fused body `activation_nvfp4_quant_fusion_kernels.cu:30-163`, helpers `nvfp4_utils.cuh:25-36,118-329`, generated zero allocation `_custom_ops.py:50-92`; cache lifecycle `kernel_warmup.py:133-213`; model-owned alpha `compressed_tensors_w4a4_nvfp4.py:95-141`, `kernels/linear/nvfp4/flashinfer.py:97-176`; FA2 backend `vllm/v1/attention/backends/flash_attn.py:674-721,935-977` and dependency `flash_api.cpp:262-327,587-714`; [benchmark protocol](benchmark-protocol.md) | [schema-v5 validator](../tools/bench/online_gate.py); [summary](../tools/bench/online_gate_summary.py); [twelve-report driver](../scripts/dgx-online-serving.sh); [probe](../tools/bench/nsys_cuda_profiler_probe.cu); default-off packed [fused producer](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1207); W3-G [FA2 adapter](../src/vt/cuda/cuda_flash_attn_fa2.cu#L429) | Schema-v5 [range](../tests/tools/test_online_gate_client.py#L956), [12-report](../tests/tools/test_online_gate_client.py#L1472), and [summary](../tests/tools/test_online_gate_summary.py#L286) contracts remain green. H1d selects fused SiLU→FP4 in 12/12 reports. Clean W3-I1 `15c6b89` passes exact CUDA/operator/memcheck/model/SASS gates. Paired 27B trace proves **896/896** packed graph calls, explicit zero nodes, unchanged lifecycle and a **36.68%** smaller comparable slice; the 35B trace records zero dispatch. The complete 48-axis component remains pending; `3f256ab` stays **55/124** and 35B performance stays blocked. See [W3-I](specs/nvfp4-fused-silu-producer.md) and the [scoreboard](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md); [W3-I spike](specs/nvfp4-fused-silu-producer.md) | `PARTIAL` | - |
