...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; cache lifecycle `kernel_warmup.py:133-213`; model-owned alpha `compressed_tensors_w4a4_nvfp4.py:95-141`, `kernels/linear/nvfp4/flashinfer.py:125-170`; FA2 backend `vllm/v1/attention/backends/flash_attn.py:674-721,935-977` and dependency `flash_api.cpp:262-327,587-714`; [benchmark protocol](benchmark-protocol.md) | [oracle contract](../tools/bench/online_gate.py#L48); [summary](../tools/bench/online_gate_summary.py#L584); [driver](../scripts/dgx-online-serving.sh#L356); current FA2 prefill adapter [cuda_flash_attn_fa2.cu:126](../src/vt/cuda/cuda_flash_attn_fa2.cu#L126) and ratio-6 decode fallback [cuda_paged_attn.cu:1854](../src/vt/cuda/cuda_paged_attn.cu#L1854) | W3-C control completes; W3-E strict-fails **39/40 timing + 1/8 memory**. W3-F immutable `7517af4` passes CUDA/operator/memcheck/both-27B/35B-inertness/paired-trace gates but strict-fails its completed component at **27/40 timing + 3/8 memory**, so `3f256ab` remains **55/124**. The closed scan selects W3-G FA2 ratio-6 split-KV decode from actual traces; its full implementation/test/capture/trace/component contract is accepted but every result is `PENDING`. Exact rerun and 35B performance remain blocked. See [W3-F ledger evidence](parity-ledger.md#L378) and [BENCHMARKS](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md) | `PARTIAL` | - |
