...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs pinned vLLM | local vLLM `e24d1b24`; [benchmark protocol](benchmark-protocol.md) | [bench main:1](../examples/bench/main.cpp#L1); [online driver](../scripts/dgx-online-serving.sh#L1) | both token-exact greedy model gates pass (`tests/parity/test_qwen36_paged_engine.cpp:140`; `tests/parity/test_qwen27_paged_engine.cpp:80`). Historical offline and old online/trace ratios are void for recorded mismatches. Exact f065 27B online baseline is valid but below floor: 0.9616/0.9258/0.9364/0.9450/0.9775/0.9722× throughput, 3–5/20 timing and 2/4 memory axes pass; corrected trace/lifecycle/model contracts pass. Direct-library, optimized 27B and all exact 35B axes remain open; [benchmark checkpoint](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md) | `PARTIAL` | - |
