...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; cache lifecycle `kernel_warmup.py:133-213`; [benchmark protocol](benchmark-protocol.md) | [oracle contract](../tools/bench/online_gate.py#L48); [summary](../tools/bench/online_gate_summary.py#L584); [driver](../scripts/dgx-online-serving.sh#L356) | token-exact [35B](../tests/parity/test_qwen36_paged_engine.cpp#L140)/[27B](../tests/parity/test_qwen27_paged_engine.cpp#L116) gates pass; `3f256ab` remains **55/124**. W3-C1 cache schema/import/atomicity code [source:528](../src/vt/cuda/nvfp4_persistent_cache.cpp#L528) and [tests:178](../tests/vt/test_nvfp4_persistent_cache.cpp#L178) pass Release/ASan+UBSan/TSan **6/6 + 174/174**, exact 64-plan import and full CPU **103/103**. No backend/runtime path consumes it, so ratios remain unchanged. C2 CUDA publication/model/same-plan gates, exact rerun and 35B performance are `PENDING`; see [BENCHMARKS](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md) | `PARTIAL` | - |
