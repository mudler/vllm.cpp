...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; cache lifecycle `kernel_warmup.py:133-213`; [benchmark protocol](benchmark-protocol.md) | [oracle contract](../tools/bench/online_gate.py#L48); [summary](../tools/bench/online_gate_summary.py#L584); [driver](../scripts/dgx-online-serving.sh#L356) | token-exact [35B](../tests/parity/test_qwen36_paged_engine.cpp#L140) remains historical; W3-C2 runtime/cache tests and memcheck pass. Immutable `d211b8f` proves six fresh [27B](../tests/parity/test_qwen27_paged_engine.cpp#L116) processes plus the corrected 12-leg component use identical **64/64** native maps with zero tuning/misses and fixed **235/235 + 16/16** gates. W3-C3R proves direct/fallback **6/6 x 128-token equality** with identical sequential batch shape and executes the exact production-default vLLM contrast: both engines are batch-shape dependent when `VLLM_BATCH_INVARIANT` is off. The stopped predecessor remains `VOID`; the corrected W3-E component gains **1.004483×/1.005044×** c2/c16 throughput but fails **39/40 timing + 1/8 memory**. `3f256ab` remains **55/124**; exact rerun and 35B performance remain blocked. See [BENCHMARKS](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md) | `PARTIAL` | - |
