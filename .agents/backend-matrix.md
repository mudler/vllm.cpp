...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; cache lifecycle `kernel_warmup.py:133-213`; [benchmark protocol](benchmark-protocol.md) | [oracle contract](../tools/bench/online_gate.py#L48); [summary](../tools/bench/online_gate_summary.py#L584); [driver](../scripts/dgx-online-serving.sh#L356) | token-exact [35B](../tests/parity/test_qwen36_paged_engine.cpp#L140) remains historical; W3-C2 default/fallback [27B](../tests/parity/test_qwen27_paged_engine.cpp#L116) each pass **235/235 + 16/16** with exact **64/64 loaded, 0 tuned/rejected/saved**. Runtime/cache lifecycle tests [source:524](../src/vt/cuda/cuda_matmul_nvfp4_cutlass.cu#L524), [tests:1665](../tests/vt/test_ops_nvfp4_fp4.cpp#L1665) and memcheck pass. `3f256ab` remains **55/124** because no C2 performance run exists. Six-process/same-plan/exact rerun and 35B performance are `PENDING`; see [BENCHMARKS](../docs/BENCHMARKS.md) | [CUDA inventory](specs/cuda-architecture-inventory.md); [W3-C spike](specs/nvfp4-persistent-plan-cache.md) | `PARTIAL` | - |
