...
| `BACKEND-GATE-CUDA-SGLANG` | CUDA low-concurrency serving vs SGLang | [SGLang v0.5.12.post1](https://github.com/sgl-project/sglang/releases/tag/v0.5.12.post1) initially; exact commit pinned per run | [bench main:1](../examples/bench/main.cpp#L1), [server main:1](../examples/server/main.cpp#L1) | - | [competitive benchmark spike](specs/competitive-benchmarks.md) | `INVENTORIED` | - |
