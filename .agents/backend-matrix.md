...
|---|---|---|---|---|---|---|---|
| `BACKEND-GATE-CUDA-VLLM` | CUDA correctness and every-axis parity vs vLLM v0.25.0 | current pin `e24d1b24`; oracle `702f481`; async default `vllm/config/vllm.py:952-1043`; depth-2 engine path `vllm/v1/engine/core.py:519-607`; async output `vllm/v1/worker/gpu/async_utils.py:12-70`; [benchmark protocol](benchmark-protocol.md) | Existing schema-v5 validator/summary remain. The trace-only [controller](../include/vt/cuda/cuda_profiler_control.h#L13), one-lock packed/rollback [driver](../scripts/dgx-online-serving.sh#L891), mode-keyed [validator](../tools/bench/online_gate.py#L145), and marker-last [packed finalizer](../tools/bench/finalize_gdn_packed_trace.py#L218) preserve historical evidence and enforce explicit B=2 provenance; production builds have no observer | Binding `3f256ab` stays **55/124**. Clean `f344dec` closes packed W1D2/G2: [default+rollback 27B](../tests/parity/test_qwen27_paged_engine.cpp#L125) **235/235**, [CUDA GDN](../tests/vt/test_ops_gdn.cpp#L1039) **43/43**, and 35B/GGUF inertness pass. Exact-signature W1D3 tooling passes **78/78**, but paired node traces and c2/c16 remain pending. No speed credit exists; host PSS/RSS remains **22.920 GiB** and 35B performance is blocked | [CUDA inventory](specs/cuda-architecture-inventory.md); [online gate](specs/cuda-online-serving-gate.md); [packed decode](specs/gdn-packed-decode.md); [W3-I](specs/nvfp4-fused-silu-producer.md) | `PARTIAL` | - |
