...
| 8 | C3/C5/C7/C8 engine/API work | C3/C5/C6 specs accepted; C7/C8 leaf specs missing | C3 M-mtp-0 loader/head-parity leaf claimed by `CLAIM-MTP-0`; C5 is `READY` via [the joint spike](specs/sliding-local-yarn-long-context.md), next claim `KV-SLIDING-WINDOW-SPEC` / `KV-CHUNKED-LOCAL-SPEC` or the `ATTN-YARN` foundation; then spike C7/C8 | `ACTIVE` |
