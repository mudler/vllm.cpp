...
| 8 | C3/C5/C7/C8 engine/API work | C3/C5/C6 specs accepted; C7/C8 leaf specs missing | C3 M-mtp-0 remains `GATING` on its GPU recipe. C5 W1-W6 are implemented and `GATING`; W5/W6 retain CUDA/model/trace/every-axis debts. W7 `ATTN-ROPE-LONGROPE` is the next dependency-ready leaf, then W8 dynamic-NTK. Restored positive model rows and an idle GPU still gate runtime closure; then spike C7/C8 | `GATING` |
