...
| `CLAIM-NVFP4-SMALL-M-2` | `KERNEL-GEMM-NVFP4-W4A4` (`W2`) | root | isolated worktree `/home/mudler/_git/vllm.cpp-nvfp4-small-m`; DGX evidence will live under `~/work/vllm.cpp-nvfp4-small-m/<pushed-sha>/w2` plus the exact online-gate root | `codex/nvfp4-small-m` | W2 only: split CUDA template/dispatch TUs, exact 32-tactic descriptors/order, swap-AB/static/Stream-K raw launch, high-water workspace, forced-ID and upstream-ported NVFP4 tests/CMake, and owning README/BENCHMARKS/spec/matrix/roadmap/ledger/state. `VT_FP4_FULL_TACTICS=0` restores W1. No HTTP, scheduler, model or W3 persistence edits. One uncontended lock for every-tactic sanitizer + component AB/BA/AB + paired trace + exact 27B campaign | `ACTIVE` | 2026-07-12 (W1 classification complete: exact/legacy ratios 1.0002/1.0012/1.0006/1.0093/0.9996/1.0072×, strict component fail; fresh oracle 0.9680/0.9317/0.9403/0.9516/0.9944/1.0073× and still below floor. Runtime trace attributes 25.1% to absent 128x32x256 Stream-K/static tactics. Implement complete pinned family; no 35B) |
