...
| `CLAIM-NVFP4-SMALL-M-3` | `KERNEL-GEMM-NVFP4-W4A4` (`W3`) | root | isolated worktree `/home/mudler/_git/vllm.cpp-nvfp4-small-m`; oracle cache fixture under `tests/fixtures/nvfp4_flashinfer_v025_gb10/`; C2 staging `~/work/vllm.cpp-nvfp4-persistent-c2-staging/evidence`; immutable C3/C3R/corrected component `~/work/vllm.cpp-nvfp4-persistent/d211b8f80fff831a712f0bfafa4f65f1abe1892d/evidence` | `codex/nvfp4-small-m` | W3-C owns document/import/atomicity, ready-map/lifecycle/5,000-us wiring, corrected same-plan gates and C3 execution per [spike](specs/nvfp4-persistent-plan-cache.md). Other levers excluded | `ACTIVE` | 2026-07-13 (C2/six-process stability and corrected frozen-map control pass. C3R summary `a1c500b3…41de`; component summary `3a3707cb…1249`. Direct gains 1.004483×/1.005044× c2/c16, but W3-E strict-fails 39/40 timing + 1/8 memory. W3-C reproduction control complete; no exact grid/35B performance) |
...
|---|---|---|---|---|
| 1 | `SERVE-GATE-ONLINE` + FP4 repair | `3f256ab` remains 55/124; W3-C reproduction control is green. The corrected frozen-plan component completes 612/612 requests and gains 1.004483×/1.005044× c2/c16 throughput, but W3-E fails at 39/40 timing + 1/8 memory; GPU/ports/lock idle | attribute/repair W3-E peak-memory and c16 p99-TPOT misses, then resume the trace-grounded vLLM-vs-ours residual scan. No exact grid/35B performance before an every-axis component passes | `ACTIVE` |
