...
is CPU-green **78/78** with exact mode-invariant signatures after separately
hashing the 48 coupled BA nodes; immutable paired trace and component results remain
...
|---|---|---|---|---|
| 1 | `KERNEL-GEMM-BF16` + `KERNEL-GDN-PACKED-DECODE` for `SERVE-GATE-ONLINE` | `3f256ab` remains 55/124; clean `f344dec` closes W1D2/G2; exact-signature W1D3 harness passes 78/78 | execute/finalize paired node traces, then c2/c16 before qkvz | `GATING` |
