...
| `CLAIM-SPARKBENCH-FOLD` | docs-only: spark-bench fold into benchmark spec | `docs_sparkbench` | local main tree (no GPU work, no build) | `main` (docs-only edits per push policy) | `.agents/specs/competitive-benchmarks.md`, `.agents/benchmark-protocol.md`, this claim row | `ACTIVE` | 2026-07-10 |
