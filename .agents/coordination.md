...
| 8 | C3/C5/C7/C8 engine/API work | C3/C5/C6 specs accepted; C7/C8 leaf specs missing | C3 M-mtp-0 remains `GATING` on its GPU recipe. C5 W1/W2/W3 are implemented and `GATING`; claim W4 `ATTN-CHUNKED-LOCAL` next, while the restored oracle and positive model rows gate W2/W4 G4-G9. `ATTN-YARN` also remains claimable. Then spike C7/C8 | `GATING` |
