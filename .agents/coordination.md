...
|---|---|---|---|---|
| 1 | `SERVE-GATE-ONLINE` async-credit control | `3f256ab` remains 55/124; `2ec6dda` ON-r1 passes 6/6 but whole series is VOID because validation stopped before OFF | create a fresh root; require completed=6/failed=0 plus six falsey error strings, then repeat all six timing legs + two traces under one lock. If credit explains 4–6%, activate W3; if neutral, map low-batch RMSNorm | `ACTIVE` |
