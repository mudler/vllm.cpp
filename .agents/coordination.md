...
| `CLAIM-SERVE-GATE-1` | `SERVE-GATE-ONLINE`, `KERNEL-GEMM-NVFP4-W4A4` | root takeover | binding grid `~/work/vllm.cpp-online-gate/evidence/3f256abdbb558e162bf8a2196284deb119648560`; W3-F immutable evidence `~/work/vllm.cpp-nvfp4-device-alpha/7517af4f983fe322ac88ce2d9869e1441b7be3fd/evidence`; local `/home/mudler/_git/vllm.cpp-nvfp4-small-m` | current checkpoint `codex/nvfp4-small-m` | online harness/evidence/matrices; fresh multi-lens executed-path scan. ONE `flock` around a complete model A/B+trace | `ACTIVE` | 2026-07-13 (`3f256ab` remains 55/124. W3-C frozen-map control passes; W3-E strict-fails 39/40 timing + 1/8 memory. W3-F CUDA/model/trace pass but strict component fails 27/40 timing + 3/8 memory at 1.001967×/1.000144× c2/c16. No exact grid/35B performance; fresh trace/source/dependency scan active) |
...
|---|---|---|---|---|
| 1 | `SERVE-GATE-ONLINE` + hot-path repair | `3f256ab` remains 55/124; W3-C reproduction control is green, W3-E fails 39/40 timing + 1/8 memory, and W3-F fails 27/40 timing + 3/8 memory despite structural closure. GPU/lock/port are idle | finish the fresh multi-lens vLLM/ours trace/source/dependency scan, rank and spike one bounded executed lever. No exact grid/35B performance before a future every-axis component passes | `ACTIVE` |
