...
| `CLAIM-NVFP4-SMALL-M-3` | `KERNEL-GEMM-NVFP4-W4A4` (`W3`) | root | isolated worktree `/home/mudler/_git/vllm.cpp-nvfp4-small-m`; oracle cache fixture under `tests/fixtures/nvfp4_flashinfer_v025_gb10/`; C2 staging `~/work/vllm.cpp-nvfp4-persistent-c2-staging/evidence`; immutable C3 `~/work/vllm.cpp-nvfp4-persistent/d211b8f80fff831a712f0bfafa4f65f1abe1892d/evidence` | `codex/nvfp4-small-m` | W3-C owns document/import/atomicity, ready-map/lifecycle/5,000-us wiring, same-plan gates and fixed-plan failure localization per [spike](specs/nvfp4-persistent-plan-cache.md). Other levers excluded | `ACTIVE` | 2026-07-13 (C2 and six-process stability pass: identical 64/64 map, zero tuning/misses, six 235/235 + 16/16 gates. C3 same-plan output fails 2/6 at first c2 pair; series stopped/void. Localization `READY`; no ratio/exact grid/35B performance) |
...
|---|---|---|---|---|
| 1 | `SERVE-GATE-ONLINE` + FP4 repair | `3f256ab` remains 55/124; W3-E failed. W3-C runtime plus six-process 64/64 stability is green, but first same-plan c2 pair fails long-output equality 2/6; GPU/ports/lock idle | localize direct-versus-composed divergence per fixed plan/request/logit/tensor, repair or reclassify W3-E, then rerun full C3. No exact grid/35B performance before acceptance | `ACTIVE` |
