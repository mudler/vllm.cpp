...
| `CLAIM-NVFP4-SMALL-M-3` | `KERNEL-GEMM-NVFP4-W4A4` (`W3`) | root | isolated worktree `/home/mudler/_git/vllm.cpp-nvfp4-small-m`; oracle cache fixture under `tests/fixtures/nvfp4_flashinfer_v025_gb10/` | `codex/nvfp4-small-m` | W3-C owns document/import/atomicity, ready-map/lifecycle/5,000-us wiring and same-plan gates per [spike](specs/nvfp4-persistent-plan-cache.md). Other levers excluded | `ACTIVE` | 2026-07-13 (C1 complete: Release/ASan+UBSan/TSan 6/6 +174/174, full CPU 103/103, exact 64-plan import. C2 `READY`; no CUDA/model/performance yet) |
...
|---|---|---|---|---|
| 1 | `SERVE-GATE-ONLINE` + FP4 repair | `3f256ab` remains 55/124; W3-E failed. W3-C1 schema/import/atomicity is CPU/sanitizer-green; GPU/ports/lock idle | implement C2 ready-map/5,000-us/lifecycle/load-save integration, then six-process 64/64 and one frozen-map c2/c16 all-axis A/B. No exact grid/35B performance before acceptance | `ACTIVE` |
