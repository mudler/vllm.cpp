...
| `CLAIM-NVFP4-SMALL-M-3` | `KERNEL-GEMM-NVFP4-W4A4` (`W3`) | root | isolated worktree `/home/mudler/_git/vllm.cpp-nvfp4-small-m`; immutable W3-A evidence `~/work/vllm.cpp-nvfp4-small-m/71f1e894d0c5e496607d08cfe9089a9944128271/w3`; immutable W3-B evidence `~/work/vllm.cpp-nvfp4-small-m/d7cdf66db0cfcc53d68d49613623ec6cd3807641/w3b`; binding v0.25 campaign `~/work/vllm.cpp-online-gate/evidence/9cc71918dbdc10f014c02feb9bab1d00963a16fe` | `codex/nvfp4-small-m` | W3 owns the highest-ranked executed FP4 topology/selection repair. A/B correctness and structural evidence remain; C persistence stays separately optional. Do not implement direct-swizzled scales, resident alpha or another topology change unless the completed paired trace proves it is on the remaining path | `ACTIVE` | 2026-07-12 (`9cc7191` exact v0.25 27B grid/trace completes with 54/124 axes passing. Trace status and ours/vLLM kernel-summary hashes are `f38b149d…d17`, `8bba1bb1…8f4`, `80999085…d2`. Diff/rank the executed path before topology work; 35B held) |
...
|---|---|---|---|---|
| 1 | `SERVE-GATE-ONLINE` + FP4 repair | Binding immutable `9cc7191` v0.25 27B evidence is complete: model gate, 36 groups/2,016 requests, six returns and paired traces pass; all 124 axes bind, 54 pass and 70 fail. c16/c32 total throughput passes, while low-concurrency decode and host PSS/RSS remain red. GPU/port/lock exit idle | diff the actual paired kernel lists, rank gain÷effort, run the highest-ranked same-binary 27B repair A/B, and repeat the exact grid until every axis passes. Modernize/delete only trace-proven paths, gate W3-C separately, and run 35B only after full 27B closure | `ACTIVE` |
