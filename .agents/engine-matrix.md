...
| `SERVE-ASYNC-LLM` | AsyncLLM-equivalent streaming engine API: per-request collectors, concurrent submit/generate/abort, live completion/chat SSE with disconnect abort, and additive nonblocking C requests. CPU implementation is gated; GB10 token/online/performance/memory gates remain | T0 | `vllm/v1/engine/async_llm.py:70,280,524,637,709`; `vllm/v1/engine/output_processor.py:45-105`; `tests/v1/engine/test_async_llm.py:109,157,228,306,340,598` | `include/vllm/v1/engine/async_llm.h:45`; `src/vllm/v1/engine/async_llm.cpp:32,136,161`; `src/vllm/v1/engine/output_processor.cpp:18,364`; `src/vllm/entrypoints/openai/api_server.cpp:197`; `src/capi/vllm_c.cpp:391` | `tests/vllm/v1/test_async_llm.cpp:208,237,276,306,332,360,387`; `tests/vllm/v1/test_output_processor.cpp:274,309`; `tests/vllm/entrypoints/openai/test_api_server.cpp:403,449,483,617`; `tests/capi/test_capi.cpp:574,606,640` | [async-serving.md](specs/async-serving.md) | `GATING` | - |
...
| `SERVE-GATE-ONLINE` | Same-corpus online serving correctness, TTFT/TPOT/ITL, throughput, and peak-memory gate vs vLLM | T0 | `vllm/entrypoints/cli/benchmark/serve.py:1`; `vllm/benchmarks/serve.py:1`; `tests/benchmarks/test_serve_cli.py:1` | `examples/server/main.cpp:60,121`; `examples/bench/main.cpp:40,109`; `examples/bench/bench_core.h:96,468` | harness `tests/examples/test_bench.cpp:15,48`; first DGX campaign invalid/incomplete; 35B exact-shape sanitizer diagnostic clean 3/3; second 27B same-lock ours→vLLM campaign active, not yet gate evidence | [online serving gate](specs/cuda-online-serving-gate.md) | `ACTIVE` | CLAIM-SERVE-GATE-1 |
