...
|---|---|---|---|---|---|
| `MODEL-GATE-QWEN35` | Qwen3.5/3.6 dense + MoE wrappers | `models/registry.py:556-560` | `PARTIAL` | 27B/35B **text submodels** pass token/perf gates; local plain-BF16 4B is diagnostic at 15/16 representative greedy sequences and below vLLM throughput; both upstream IDs are multimodal wrappers and their ViT/merger paths are absent | model matrix + existing Qwen specs |
