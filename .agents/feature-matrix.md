...
| llama3 / longrope / dynamic-NTK scaling | same | `ACTIVE` T1–T2 | umbrella split into three independently claimable engine leaves. W6 Llama 3 low/mid/high and W7 Phi-3 LongRoPE short/long global-selection formulas pass six combined pinned-source f32/bf16 fixtures plus CPU/sanitizers; CUDA apply, Llama-3.1/Phi-3 e2e and G9 remain gated. W8 dynamic-NTK is active under `CLAIM-C5-DYNAMIC-1` | [sliding-local-yarn-long-context.md](specs/sliding-local-yarn-long-context.md) |
