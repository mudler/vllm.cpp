...
| Sliding-window attention backend | `v1/attention/backends/` | `ACTIVE` T1 (`CLAIM-C5-SW-ATTN-1`) | W2 claimed for the shared semantic window, CPU/portable-CUDA lower bound, vendored FA2 propagation and upstream-derived operator tests; model-positive/oracle/trace/performance closure remains gated | [sliding-local-yarn-long-context.md](specs/sliding-local-yarn-long-context.md) |
