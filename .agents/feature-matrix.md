...
| GDN packed pure decode | `envs.py::VLLM_ENABLE_FLA_PACKED_RECURRENT_DECODE`, `fla/ops/fused_recurrent.py` | `ACTIVE` T0 | `KERNEL-GDN-PACKED-DECODE` mirrors vLLM's default pure non-spec branch across FP16/BF16/F32. Clean `f344dec` closes W1D2/G2 for dispatch, independent state dtypes, metadata preflight, rollback, default+rollback 27B **235/235**, 35B/GGUF inertness and CUDA safety. Trace/c2/c16 remains open | [gdn-packed-decode.md](specs/gdn-packed-decode.md) |
