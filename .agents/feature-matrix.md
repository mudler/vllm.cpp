...
|---|---|---|---|---|
| `QUANT-CUDA-GATES` | NVFP4 W4A16, NVFP4 W4A4, gate-specific FP8 W8A8 | `DONE` | support/correctness stays closed; performance remains `ACTIVE` at `3f256ab` **55/124**. W3-C reproduction control passes; W3-E/W3-F/W3-G earn no speed credit. W3-H accepts fused SiLU→FP4 as the first residual in 12/12 reports; [W3-I](specs/nvfp4-fused-silu-producer.md) I1 is now implemented default-off and dirty-root correctness/safety/model/SASS preflight-green, with immutable trace/performance pending. Quant support and binding performance are unchanged | quant matrix §2 + [coverage spike](specs/quantization-coverage.md) |
