...
| GDN packed pure decode | `envs.py::VLLM_ENABLE_FLA_PACKED_RECURRENT_DECODE`, `fla/ops/fused_recurrent.py` | `ACTIVE` T0 | `KERNEL-GDN-PACKED-DECODE` mirrors vLLM's default pure non-spec branch across FP16/BF16/F32. Clean `f344dec` closes W1D2/G2. Exact-signature W1D3 trace contracts/driver/finalizer pass **78/78** tools, including exact 48-node coupled-BA isolation; immutable trace and c2/c16 remain open with no speed credit | [gdn-packed-decode.md](specs/gdn-packed-decode.md) |
