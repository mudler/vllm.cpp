...
|---|---|---|---|---|
| `QUANT-CUDA-GATES` | NVFP4 W4A16, NVFP4 W4A4, gate-specific FP8 W8A8 | `DONE` | support/correctness stays closed; performance remains `ACTIVE` at `3f256ab` **55/124**. W3-C reproduction control passes; W3-E/W3-F/W3-G earn no speed credit. W3-H H1d is accepted at status `84d15970…6e66`; fused SiLU→FP4 is the largest positive mapped residual in 12/12 reports, displacing normal W3-H2 pending a new spike. Quant support and binding performance are unchanged | quant matrix §2 + [coverage spike](specs/quantization-coverage.md) |
