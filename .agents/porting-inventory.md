...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance ACTIVE** — `3f256ab` binds at **55/124**. Finalized `179a0fc` proves the FP4 tactic family already matches. Selected `KERNEL-GEMM-BF16` W1C is `ACTIVE`: finalized `0091cd1` closes exact 963/145 versus 1,011/193 structure. Immutable `f925294` passes local BA projection 14/14, loader 73/73, native 35B 315/315, real GGUF 28/28 and default 27B 235/235; BF16 27B remains 233/235, localizing the gap downstream of GEMM. First-divergence, component evidence, qkvz, exact grid and 35B performance remain unauthorized; `benchmark_binding=false` |
