...
| GDN packed pure non-spec decode (default-on FP16/BF16/F32 path) | `layers/fla/ops/fused_recurrent.py:255-478`; Qwen dispatch `qwen_gdn_linear_attn.py:1286-1298,1644-1695` | T0 🚧 `KERNEL-GDN-PACKED-DECODE` `ACTIVE`: clean `f18ca23` closes immutable G0 with a byte-identical official fixture and CUDA **10/10**, reproducing F32 in-kernel q/k normalization plus dtype-rounded beta at `306/7552 -> 0/1`. Production op, full dtype/stride matrix, 235/235, trace and c2/c16 remain pending |
