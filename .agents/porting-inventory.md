...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — existing CUDA paths remain gated; `3f256ab` binds at **55/124** and W3-E strict-fails. W3-C1 now implements pure-C++ native/import JSON, full metadata/layout/device/tactic validation, deterministic merge, atomic replace, environment/frozen modes and all 64 oracle IDs. Release/ASan+UBSan/TSan pass **6/6 + 174/174**, full CPU **103/103**. Runtime plan publication/CUDA/model/performance are absent and remain C2/C3 `PENDING`; no ratio, exact grid or 35B performance changes. See [W3-C spike](specs/nvfp4-persistent-plan-cache.md) |
