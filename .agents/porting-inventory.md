...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — `3f256ab` binds at **55/124**. W3-C frozen-plan control passes; W3-E/W3-F/W3-G earn no credit. W3-H is trace-first: schema-v5 `a7f67c7` closes one four-report group but is VOID on a repaired stop-marker log-forwarding race in session 2. Execute a fresh immutable 12-report DGX run. No exact grid or 35B performance is authorized. See [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) |
