...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — `3f256ab` binds at **55/124**. W3-C frozen-plan control passes; W3-E/W3-F/W3-G earn no credit. W3-H `c498a413` passes status `84d15970…6e66`; fused SiLU→FP4 ranks above normal in 12/12 reports, displacing normal H2 pending a fused-producer spike. No exact grid or 35B performance is authorized. See [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) |
