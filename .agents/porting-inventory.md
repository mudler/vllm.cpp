...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — existing CUDA paths remain gated; `3f256ab` binds at **55/124** and W3-E strict-fails. W3-C2 now installs exact imported/native plans before warmup, validates source/device/tactic identity, freezes misses, mirrors 3/5,000-us/10 timing and publishes only completed warmups. Exact 64/64 zero-tune import, lifecycle/memcheck and both frozen 27B arms pass. Six-process/same-plan performance remains C3 `PENDING`; no ratio, exact grid or 35B performance changes. See [W3-C spike](specs/nvfp4-persistent-plan-cache.md) |
