...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — `3f256ab` binds at **55/124**. W3-C control passes; W3-E/W3-F/W3-G earn no credit. H1d selects fused SiLU→FP4; clean [W3-I](specs/nvfp4-fused-silu-producer.md) `15c6b89` passes implementation/safety/model/SASS/paired-trace gates and reduces its comparable graph slice **36.68%**. The 48-axis component, exact grid, and 35B performance remain unauthorized |
