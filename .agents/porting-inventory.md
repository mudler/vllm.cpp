...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — `3f256ab` binds at **55/124**. W3-C frozen-plan control passes; W3-E/W3-F/W3-G earn no credit. W3-H `c498a413` selects fused SiLU→FP4 in 12/12 reports; [W3-I](specs/nvfp4-fused-silu-producer.md) I1 now ports the opt-in packed BF16/direct-swizzled path and passes dirty-root operator/safety/model/SASS preflight. Immutable trace/component, exact grid, and 35B performance remain unauthorized |
