...
|---|---|---|
| **NVFP4 gate slices** — ModelOpt W4A16 experts (35B) + compressed-tensors W4A4 dense (27B) | `quantization/modelopt.py`, `compressed_tensors/` | **T0 ✅ correctness/support; performance W3 ACTIVE** — `3f256ab` binds at **55/124**. Clean [W3-I](specs/nvfp4-fused-silu-producer.md) `15c6b89` passes structural gates, but its complete component fails **27/40 timing + 3/8 memory**; c2/c16 total ratios are **1.002457× / 0.999771×**. Candidate remains default-off. Exact grid and 35B performance remain unauthorized while the next cross-stack lever is re-ranked |
