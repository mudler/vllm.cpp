...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [merged/tactic dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L3112), [fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1137), [pre-serve warmup](../src/vllm/entrypoints/model_loader.cpp#L211), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L882), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness stays closed. Separate serving performance has binding immutable `9cc7191` v0.25.0 evidence: 36/36 groups, 2,016/2,016 requests and six returns pass; **54/124 axes pass and 70 fail**. Total ratios c1→c32 are 0.9901/0.9491/0.9633/0.9770/1.0288/1.0467×; host PSS/RSS fail at 0.5855/0.5934×. Its first ours trace omitted CUDA-graph child nodes, so a node-level paired recapture is pending before any FP4 topology repair. This does not reopen quant support `DONE`, but keeps W4A4 performance `ACTIVE`; no 35B result is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M performance spike](specs/nvfp4-small-m-dispatch.md) | `83010c7` |
