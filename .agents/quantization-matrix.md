...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414) and [support ledger](parity-ledger.md#L284) remain. W3-C frozen-plan control is complete; W3-E/W3-F strict-fail. `3f256ab` remains 55/124; no speed credit or 35B performance is claimed. W3-G's completed attention component reaches **1.017668×/1.006548×** mean throughput but strict-fails **35/40 timing + 5/8 memory**, without changing quant support. W3-H is an **ACTIVE / trace-first** performance investigation only: H1a/H1b/H1c and H1d attempts through `a96e899` are `VOID`; the latest closes four replays but SIGTERM yields Nsight exit 143 before validation. H1d now binds exact CUTLASS/Triton-AOT/FA2/toolchain provenance, actual Nsight ancestry, diagnostic-only synchronous SIGUSR1 graceful stop and zero-exit lossless semantics. No quant implementation, support-state change, ratio or speed credit exists | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) | `83010c7` |
