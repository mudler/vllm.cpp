...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414), and [support ledger](parity-ledger.md#L284) remain. W3-C control passes; W3-E/W3-F/W3-G earn no speed credit; `3f256ab` stays 55/124. W3-H is trace-only: schema-v4 `b9beccd` remains VOID after four complete zero-eager reports. The committed probe isolates its warning to pinned Nsight's capture boundary, and schema-v5 exact event/completion/model-topology reconciliation is CPU-green; a fresh immutable 12-report DGX run is pending. No quant implementation/support-state/ratio change exists | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) | `83010c7` |
