...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [direct/merged dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [direct activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [process-local prewarm](../src/vllm/entrypoints/model_loader.cpp#L211), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness stays closed. Serving performance remains `ACTIVE`: `3f256ab` binds at **55/124**; W3-E removes **624** swizzles but strict-fails its component at **32/40 timing + 6/8 memory**. v0.25 loads a 64-entry persistent cache while ours retunes with only 18--33/64 paired IDs matching. W3-C is spiked/`READY`; persistent/import/frozen code and all benchmarks are `PENDING`. No binding ratio changes and no 35B performance result is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M spike](specs/nvfp4-small-m-dispatch.md); [direct-scale spike](specs/nvfp4-direct-swizzled-scales.md); [persistent-cache spike](specs/nvfp4-persistent-plan-cache.md) | `83010c7` |
