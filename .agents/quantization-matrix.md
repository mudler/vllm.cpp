...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414) and [support closure](parity-ledger.md#L284) remain. W3-C2 now imports/publishes plans at [prewarm:243](../src/vllm/entrypoints/model_loader.cpp#L243); exact 64/64 zero-tune frozen map, cache lifecycle/memcheck and default/fallback [27B gate:116](../tests/parity/test_qwen27_paged_engine.cpp#L116) **235/235 + 16/16** pass. Performance is pending; `3f256ab` remains 55/124 and no 35B performance is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md) | `83010c7` |
