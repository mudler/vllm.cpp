...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [merged/tactic dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L3112), [fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1137), [pre-serve warmup](../src/vllm/entrypoints/model_loader.cpp#L211), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L882), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness remains closed and clean `b5c6e4f` stays below the separate serving floor. Corrected W3-B tracing closes the original FP4 tactic-family mismatch. Clean pushed `3cc490c` is now active in the exact 27B performance campaign; model/corpus/cache preconditions, ours repetition 1 c1-c32 and its memory return pass, and vLLM repetition 1 is running. The quantization support row stays `DONE`; no partial performance ratio or 35B result is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M performance spike](specs/nvfp4-small-m-dispatch.md) | `83010c7` |
