...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414) and [support ledger](parity-ledger.md#L284) remain. W3-C frozen-plan control is complete; W3-E strict-fails at **39/40 timing + 1/8 memory**. W3-F implements the vLLM/FlashInfer device F32 pointer and strict-fails its component at **27/40 timing + 3/8 memory**. `3f256ab` remains 55/124; no speed credit or 35B performance is claimed. Separate W3-G FA2 decode immutable `ae9e8ff` passes CUDA/memcheck/model/paired-trace gates; both arms retain identical **3,536 FP4 GEMMs**, **3,536 producers**, eight CUTLASS identities and the frozen 64-plan SHA. This confirms no quant loader/kernel/support state changes; its attention component is active under one lock with no partial result accepted. Vectorized normal FP4 production remains the next unstacked quant lever | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md) | `83010c7` |
