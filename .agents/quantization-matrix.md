...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414), and [support ledger](parity-ledger.md#L284) remain. `3f256ab` stays 55/124. Clean W3-I1 `15c6b89` passes structural gates but its complete component is **27/40 timing + 3/8 memory**, with c2/c16 total ratios **1.002457× / 0.999771×**. Accepted async `3812d8` is also neutral; exact c2 resolved-FP4-tactic/RMSNorm mapping is next. The candidate remains default-off, so quantization support state and binding performance are unchanged | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md); [W3-I spike](specs/nvfp4-fused-silu-producer.md) | `83010c7` |
