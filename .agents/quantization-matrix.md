...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414) and [support ledger](parity-ledger.md#L284) remain. W3-C frozen-plan control is complete; W3-E and W3-F strict-fail. `3f256ab` remains 55/124; no speed credit or 35B performance is claimed. Separate W3-G FA2 decode immutable `ae9e8ff` passes CUDA/memcheck/model/paired-trace gates and both arms retain identical **3,536 FP4 GEMMs**, **3,536 producers**, eight CUTLASS identities and the frozen 64-plan SHA, confirming no quant loader/kernel/support state change. Its completed component reaches **1.017668×/1.006548×** mean total throughput but strict-fails **35/40 timing + 5/8 memory**. W3-H is an **ACTIVE / trace-first** performance investigation only: H1a/H1b are `VOID`, and immutable `d1f8e33` H1c is also `VOID` because capture 1/3 emitted possible CUDA-event loss, stopped before r2/r3/vLLM and retained no parseable frozen-plan lifecycle. H1d collector and semantic validator hardening is pending; no quant implementation, support-state change, ratio or speed credit exists | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md); [W3-G spike](specs/fa2-gqa-split-kv-decode.md); [W3-H spike](specs/nvfp4-bf16-producer-vectorization.md) | `83010c7` |
