...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [merged/tactic dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L3112), [fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1137), [pre-serve warmup](../src/vllm/entrypoints/model_loader.cpp#L211), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L882), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness remains closed and clean `b5c6e4f` stays below the separate serving floor. Clean `d7cdf66` W3-B passes focused/model/memcheck/readiness gates at 80/80 profiles and zero misses; its component strict-fails but first-use improves. Corrected trace attempt 2 completes **432/432** retained requests with lifecycle return and records prewarm/lazy/vLLM FP4 sums **110.623/114.229/109.932 s**. Prewarm is within **0.63%** of vLLM and matches the narrow pair at **70.333/70.986 s**; profiled mean TPOT remains below floor and is diagnostic. The quantization support row stays `DONE`; exact serving performance remains `ACTIVE` in its owning engine/backend/kernel rows | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M performance spike](specs/nvfp4-small-m-dispatch.md) | `83010c7` |
