...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | Existing [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414) and [support ledger](parity-ledger.md#L284) remain. W3-C frozen-plan control is complete; W3-E strict-fails at **39/40 timing + 1/8 memory**. W3-F now specifies replacing [per-GEMM alpha staging](../src/vt/cuda/cuda_matmul_nvfp4_cutlass.cu#L914) with the vLLM/FlashInfer model-owned device F32 pointer; read-only traces show 208 local scalar launches/forward versus zero in vLLM. W3-F is spike-only/`READY`; no implementation/result. `3f256ab` remains 55/124 and no 35B performance is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); MVP closure `83010c7`; [W3-C spike](specs/nvfp4-persistent-plan-cache.md); [W3-F spike](specs/nvfp4-device-alpha.md) | `83010c7` |
