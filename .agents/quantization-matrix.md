...
| `QUANT-GGUF-CPU-THREADPOOL` | vt CPU threadpool + chunked parallel op dispatch (GEMM first, then row/batch ops); bit-identical to single-thread; prerequisite leaf | llama.cpp `ggml/src/ggml-cpu/ggml-cpu.c:471-610` (pool/barrier/chunk), `:3024-3390` (workers), `:1155-1443` (mul_mat chunking) at `237ad9b96` | absent — [cpu_ops.cpp:30](../src/vt/cpu/cpu_ops.cpp#L30) is single-threaded scalar loops, [cpu_backend.cpp:11](../src/vt/cpu/cpu_backend.cpp#L11) has no thread state | single-thread B4 floor measured ([ledger B4 row](parity-ledger.md#L290)); determinism + ≥10× decode gates defined in the leaf spec | [threadpool leaf](specs/gguf-cpu-threadpool.md) | `ACTIVE` | `CLAIM-QGCT-1` |
...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L2836), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L48), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L110), [final gate ledger](parity-ledger.md#L284) | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7` | `83010c7` |
