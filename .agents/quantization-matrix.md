...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [direct/merged dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L1054), [direct normal/fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L958), [pre-serve warmup](../src/vllm/entrypoints/model_loader.cpp#L211), [direct/padded tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L414), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness stays closed. Separate serving performance has binding immutable `3f256ab` v0.25.0 evidence: **55/124 axes pass and 69 fail**. W3-E mirrors direct swizzled activation scales with `VT_FP4_DIRECT_SF=0`: CPU/CUDA byte parity, focused sanitizer, direct/fallback 27B **235/235 + 16/16**, and 35B inertness **315/315** pass; tracing removes all **624** activation-scale swizzles. Immutable `53ab149` c2/c16 direct/fallback gains **1.002108× / 1.006222×** mean total throughput but strict-fails **32/40 timing + 6/8 memory**. Thus quant support remains `DONE`, W4A4 performance remains `ACTIVE`, binding ratios do not change, the conditional exact grid did not run, and no 35B performance result is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M spike](specs/nvfp4-small-m-dispatch.md); [direct-scale spike](specs/nvfp4-direct-swizzled-scales.md) | `83010c7` |
