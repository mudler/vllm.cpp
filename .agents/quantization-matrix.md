...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [merged/tactic dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L3112), [fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1137), [pre-serve warmup](../src/vllm/entrypoints/model_loader.cpp#L211), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L882), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness stays closed. Separate serving performance has binding immutable `3f256ab` v0.25.0 evidence: **55/124 axes pass and 69 fail**. W3-D clean correctness passes; its component is 1.005049× mean-positive but strict-fails 14/20 timing +2/4 memory; post-pack topology closes at **208.192 vs vLLM 208 FP4 GEMMs/forward**. Generated code refutes the apparent norm+FP4 fusion. W3-E direct swizzled activation-scale emission is now `READY`: exact local trace attributes **320,099 / 1.238881 s** standalone swizzles while vLLM has zero standalone equivalents. Code/tests/A-B remain pending. Quant support remains `DONE`, W4A4 performance remains `ACTIVE`, and no 35B result is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M spike](specs/nvfp4-small-m-dispatch.md); [direct-scale spike](specs/nvfp4-direct-swizzled-scales.md) | `83010c7` |
