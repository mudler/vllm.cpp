...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [merged/tactic dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L3112), [fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1137), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L637), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L102), [support closure](parity-ledger.md#L284). Support/correctness remains closed. Clean `b5c6e4f` validates W2 end-to-end but stays below the separate serving floor; its trace promotes runtime warmup/tactic-selection parity to W3 under `KERNEL-GEMM-NVFP4-W4A4` | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M performance spike](specs/nvfp4-small-m-dispatch.md) | `83010c7` |
