...
| `QUANT-NVFP4-CT-W4A4` | compressed-tensors NVFP4 | W4/A4 | CUDA sm121a, 27B dense | Y | Y | Y | Y | Y | `DONE` | [weights](../src/vllm/model_executor/models/qwen3_5_dense_weights.cpp#L106), [merged/tactic dispatch](../src/vllm/model_executor/models/qwen3_5.cpp#L3112), [fused activation quant](../src/vt/cuda/cuda_matmul_nvfp4.cu#L1137), [pre-serve warmup](../src/vllm/entrypoints/model_loader.cpp#L211), [kernel tests](../tests/vt/test_ops_nvfp4_fp4.cpp#L882), [27B gate](../tests/parity/test_qwen27_paged_engine.cpp#L116), [support closure](parity-ledger.md#L284). Support/correctness stays closed. Separate serving performance has binding immutable `9cc7191` v0.25.0 evidence: **54/124 axes pass and 70 fail**. W3-D clean correctness passes; its component is 1.005049× mean-positive but strict-fails at 14/20 timing +2/4 memory. The post-pack node trace passes and confirms **208.192 vs vLLM 208 FP4 GEMMs/forward**, closing the selected QKV topology gap. This does not reopen quant support `DONE`, but keeps W4A4 performance `ACTIVE` pending the exact grid; no 35B result is claimed | [W4A4 notes](specs/qwen27b-w4a4-notes.md); phase 1 `4fef786`, accepted path `64ad26b`, MVP closure `83010c7`; [small-M performance spike](specs/nvfp4-small-m-dispatch.md) | `83010c7` |
