...
build/GPU as login `PATH` omitted Ninja and then `nvcc`. The corrected recipe
now pins and manifests both exact tools. `3f256ab` still binds at 55/124 and no
speed credit follows.
