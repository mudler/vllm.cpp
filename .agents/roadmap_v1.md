...
is `READY` with source, generated-code, SASS, test and gate inventory complete;
its opt-in implementation/component, exact grid, 35B performance, and later
portfolio remain open in that order.
