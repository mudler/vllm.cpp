...
G0 is closed; the full packed port now precedes c2/c16. qkvz stays excluded and
no diagnostic earns speed credit.
...
| # | Track | State |
|---|---|---|
| `SERVE-GATE-ONLINE` (formerly A1) | Serve-latency A/B vs `vllm serve` (TTFT/TPOT online, every-axis rule) | 🚧 immutable `3f256ab` is **FAILED/open** at 55/124. BA safety/structure/projection and packed-decode semantic G0 are closed; W1D1 operator preflight is green but immutable G1 and BF16 end-to-end 235/235 remain open. W1D2 and c2/c16 precede qkvz. Repair the 22.920 GiB host mirror before 35B performance |
