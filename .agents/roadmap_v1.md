...
| # | Track | State |
|---|---|---|
| `SERVE-GATE-ONLINE` (formerly A1) | Serve-latency A/B vs `vllm serve` (TTFT/TPOT online, every-axis rule) | 🚧 immutable `3f256ab` is **FAILED/open** at 55/124. W3-C control passes; W3-E/W3-F/W3-G earn no speed credit. H1d selects fused SiLU→FP4. [W3-I](specs/nvfp4-fused-silu-producer.md) I1 is default-off and structurally accepted at clean `15c6b89`; the complete c2/c16 performance component is pending. Strictly gate I1, then close every 27B axis before 35B performance while keeping host-memory/teardown debt separate |
