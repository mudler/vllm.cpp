...
| # | Track | State |
|---|---|---|
| `SERVE-GATE-ONLINE` (formerly A1) | Serve-latency A/B vs `vllm serve` (TTFT/TPOT online, every-axis rule) | 🚧 immutable `3f256ab` v0.25.0 27B re-baseline complete and **FAILED/open**: 12/12 performance groups, 2/2 memory groups and 124/124 axes bind; 55 pass and 69 fail. Lifecycle and paired-trace proofs pass. W3-E direct swizzled scales remove 624 activation swizzles and gain 1.002108×/1.006222× c2/c16 mean total throughput, but strict-fail **32/40 timing + 6/8 memory**; no conditional exact grid ran. Close every 27B axis before 35B performance and keep optional W3-C plus teardown debt separate |
