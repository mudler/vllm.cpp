...
| # | Track | State |
|---|---|---|
| `SERVE-GATE-ONLINE` (formerly A1) | Serve-latency A/B vs `vllm serve` (TTFT/TPOT online, every-axis rule) | 🚧 immutable `9cc7191` v0.25.0 27B re-baseline complete and **FAILED/open**: 12/12 performance groups, 2/2 memory groups and 124/124 axes bind; 54 pass and 70 fail. Paired traces and lifecycle proofs pass. Repair the trace-ranked low-concurrency decode and host-memory gaps, close every 27B axis before 35B, and keep optional W3-C plus teardown debt separate |
