...
|---|---|---|
| Weight ownership / loader | `include/vllm/model_executor/models/qwen3_5_weights.h:146-169`; `src/vllm/model_executor/models/qwen3_5_dense_weights.cpp:166-181` | Real 27B owns one raw-NK `[b,a]` tensor AND (W2A) one raw-NK `[q,k,v,z]` tensor (`in_proj_qkvz`, [conv_dim+value_dim, H]); split qkv/z/b/a owners stay empty and both rollbacks slice their merged owner. |
