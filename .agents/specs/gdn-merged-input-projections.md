...
| Remaining W1 evidence | packed model dispatch + component tools | Clean `9ad8fb7` closes W1D1/G1 for the CPU/CUDA operation, upstream matrix, capture/canaries and strict memcheck. Next wire pure-decode selection, restore 235/235 BF16 continuation, prove 48 packed calls replace the post-conv/decode pairs, and run the 40+8-axis c2/c16 component. Capture lifecycle and BA structure remain closed by `0091cd1`; qkvz stays blocked. |
...
| W1C | Repeat immutable safety/model gates, close BF16 semantics, run exact 145-node-family trace and c2/c16 BA AB/BA/AB. | `581d335` closes safety, `0091cd1` closes BA structure, `f925294` closes exact projection plus native/legacy/GGUF inertness, `f18ca23` closes packed G0 and clean `9ad8fb7` closes W1D1/G1. W1D2 model dispatch and the component remain pending. G2 must close before W2. |
