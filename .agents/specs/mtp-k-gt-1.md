...
option"). Whether a relocated CUDA virtual environment starts inside a worker is
UNMEASURED, so staging is worth attempting rather than futile. Resume this row
