...
[W1 outcome](#w1-outcome)). `QUANT-QWEN38-27B-NVFP4-ARM` is `PARTIAL` (W4
landed; see [W4 outcome](#w4-outcome)). `QUANT-QWEN38-27B-GGUF-ARM` is
`READY`.
**Owner:** unassigned
...
`QUANT-QWEN38-27B-GGUF-ARM` stays `READY`, verified against the artifacts' own
headers.
