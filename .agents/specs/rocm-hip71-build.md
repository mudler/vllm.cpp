...
`on_gfx1151()`, `YtileUnrl`, and `SelectYtileUnrl` are removed together with
the `<string_view>` include they needed. Nothing calls them after #2787, and
AGENTS.md forbids keeping dead code for a possible later caller. A future
