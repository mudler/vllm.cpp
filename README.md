...
> parity ledger. **35B performance: 19→42/124** (2026-07-18; routing/align + host-free + FA2-prefill levers, valid binding `df9a040`; c16/c32 16/20 with decode *winning* vLLM, c1–c4 still weak on TTFT + low-batch decode).6-35B-A3B-NVFP4, MoE). The MoE routing/align + host-free levers closed the high-concurrency decode (c16/c32 now WIN throughput+TPOT); remaining: **MoE host double-store FIXED (2026-07-18)** — freeing the routed-expert
