...
> decode-floor seven: fold in the two landed bit-identical FP4-quant/SiLU glue
> kernels (`861b518`, opt-in) + the GDN conv-update lever; characterize the c4
> TTFT lottery vs run-noise. Memory PASSES via the windowed-load release (`cb2d310`, ours peak PSS
