...
| MoE decoders | Mixtral, Qwen3-MoE | 🚧 | — | 🚧 **Qwen3-Coder-30B-A3B (`Qwen3MoeForCausalLM`) SPIKED 2026-07-21** ([spike](.agents/specs/sweep-qwen3-coder-30b.md)) — the first sweep model; a BF16 full-attention MoE that composes the done dense attention + 35B MoE experts (zero runner change) |
