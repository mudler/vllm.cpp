...
| Tool-call parsing | 30 dialects, streaming | Every pure-text tool parser in the pinned vLLM registry, ported 1:1 with its upstream tests (hermes, mistral, the llama/pythonic family, granite x3, deepseek v3-v4, qwen3, step3/3.5, minicpm5, hy_v3, olmo3, xlam, internlm, jamba, hunyuan, apertus, ernie45, gigachat3, lfm2, poolside, functiongemma, longcat, phi4). Selected via `tool_parser` or auto-detected from the chat template |
