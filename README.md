...
| Tool-call parsing | 12 dialects, streaming | hermes/qwen3, mistral (both wire forms), llama3_json/llama4_json, pythonic, llama4_pythonic, granite, granite4, granite-20b-fc, deepseek_v3, deepseek_v31, longcat - each a 1:1 port of the pinned vLLM parser with its upstream tests, selected explicitly (`tool_parser`) or auto-detected from the chat template's markers |
