...
> test-first from the five sealed roots. The packed component stays `GATING` (no
> speed credit) until the sixth 12-leg component from the pushed SHA reaches a
