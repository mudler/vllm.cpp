...
performance gates pass. sm_120a is the one architecture that has moved past
"inventoried" — it is a **build-supported target with evidence**, which is a
weaker and different claim than hardware support, and it stays that way until
someone runs the gates on an actual card.
