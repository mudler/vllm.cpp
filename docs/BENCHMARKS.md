...
| `READY` ([#284](https://github.com/mudler/vllm.cpp/issues/284)) | Fresh both-engine profile, then C++/NEON BF16 GEMM speed closure; assembly remains blocked until C++ exceeds llama.cpp on every speed axis |
