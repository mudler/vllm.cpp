...
| Speculation depth (`ROAD-V1-D3-SPEC-K`, #81) | **PENDING.** 27B k=4 acceptance 0.875/0.750/0.618/0.507 vs control 0.000. One-window re-run 2026-08-17: void lifted, 6/6 clear. vLLM leg blocked, oracle cannot load a 27B here ([spec](../.agents/specs/mtp-k-gt-1.md)) | the vLLM leg (our-ON == vLLM-ON) on the 27B and the whole 35B lane, then the c1/c>1 A/B at matched k + the prose vs code acceptance-vs-depth curve any depth policy needs |
