...
| DSpark | 27B NVFP4 dense k=15; 35B-A3B MoE k=8 | MoE **0.975x** code / **1.012x** prose vs the pinned graphed oracle. NOT parity: **~0.966x +/- 0.01** (3 within-session pairs). Marlin cause **REFUTED**: matched-work 0.9973x; time tracks DISTINCT EXPERTS (#442) | `ACTIVE` |
