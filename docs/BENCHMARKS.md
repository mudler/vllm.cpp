...
| DSpark | 27B NVFP4 dense k=15; 35B-A3B MoE k=8 | MoE 35B-A3B: prior within-session ratios 0.957-0.989, but the ORACLE varies 20% between invocations, so parity is UNMEASURED pending a dispersion-gated denominator (#442) | `ACTIVE` |
