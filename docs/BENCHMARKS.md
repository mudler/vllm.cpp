...
| Speculation depth (`ROAD-V1-D3-SPEC-K`, #81) | **PENDING.** 27B depth MEASURED 2026-08-16: acceptance by depth 0.875/0.750/0.618/0.507 at k=4, padded control 0.000 at depth >=1. No parity number, the vLLM leg was blocked ([spec](../.agents/specs/mtp-k-gt-1.md)) | the vLLM leg (our-ON == vLLM-ON) on the 27B and the whole 35B lane, then the c1/c>1 A/B at matched k + the prose vs code acceptance-vs-depth curve any depth policy needs |
