...
| **Record-anchor ratchet** (`ENG-RECORD-ANCHOR-RATCHET`, #632) | **No runtime number owed:** a record checker. **832 of 867** in-scope citations (**96.0%**) were already parsed; the symbol test and report were not. Rot **39** (32 stale, 7 broken) over **828** OK, **32 in range** |
