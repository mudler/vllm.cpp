...
| DSpark | 27B NVFP4 dense k=15; 35B-A3B MoE k=8 | MoE **0.975x** code / **1.012x** prose vs the pinned graphed oracle. NOT parity: **~0.966x +/- 0.01** over three within-session pairs. DRAM-bound cause **REFUTED**: latency-bound at 25% occupancy (#442) | `ACTIVE` |
