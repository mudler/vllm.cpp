...
| Qwen3.8-27B quantized arms (Q4_K_M GGUF, its `clip` mmproj, the `unsloth` "NVFP4") | Projector LOADS, nothing runs it; "NVFP4" ACCOUNTED, its FP8 arm REFUSED; Q4_K_M spec'd only | BF16 gated (#915). `--mmproj` (ABI v22) loads a `clip` GGUF into the tower. "NVFP4" is `mixed-precision` @`7d6f8d4d`: 1968 names accounted in CI, FP8 half refused. [spec](../.agents/specs/qwen38-27b-quant-arms.md) |
