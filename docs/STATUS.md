...
| CPU backend vs llama.cpp | 20-core at floor; RPi/A76 `GATING`; BF16 `READY` ([#284](https://github.com/mudler/vllm.cpp/issues/284)) | Pi: 0.461x prefill / 0.653x decode; RSS 24.2% lower. C++/NEON before assembly. |
