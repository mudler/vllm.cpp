...
| CPU backend vs llama.cpp | 20-core Arm/i8mm at floor; RPi5/A76 Q8 assembly `GATING` | Binding 20-core arm: prefill 1.18x, decode/RSS parity, tokens byte-identical. Pi: QEMU-built AAPCS64 leaf is output-exact and beats compiler SDOT 3.66-5.08% on M1/T1 and M128/T1/T4; 64-token Qwen TTFT −1.55% and E2E −0.13% vs SDOT. M1/T4 is −2.43%, so thread partition, peak memory, concurrency and same-file Pi llama.cpp floor remain open |
