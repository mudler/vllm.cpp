...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **t2va+fl2va COHERENT; ref2va assembly FIXED+gated** | fl2va matched cat; audio full-duration; ref2va block-dim bug fixed but grid RE-ATTRIBUTED to the NVFP4 ckpt, NOT assembly. §8.6-10. |
