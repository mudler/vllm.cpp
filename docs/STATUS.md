...
| CPU backend vs llama.cpp | 20-core Arm/i8mm at floor; RPi5/A76 `GATING` | Binding: prefill 1.18x, decode/RSS parity, tokens byte-identical. Pi (DotProd, no i8mm): spike complete; bring-up/PMU/perf `PENDING`. Concurrency open |
