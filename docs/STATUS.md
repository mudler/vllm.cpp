...
| CPU backend vs llama.cpp | 20-core Arm/i8mm at floor; RPi5/A76 `GATING` | Binding: prefill 1.18x, decode/RSS parity, tokens byte-identical. Pi R2-R3 is 16/16 x86-token and fixture exact; Q8 dot is 20.10% of user cycles. `KERNEL-CPU-A76-Q8-DOT` is `SPIKE`: exact-order C++ SDOT vs AAPCS64 assembly A/B next; Pi llama.cpp floor open. Concurrency open |
