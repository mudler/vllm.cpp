...
| MiniMax-H3 (`MiniMaxH3DiTModel`, omni-modal video+audio DIFFUSION) | **t2va+fl2va COHERENT; ref2va grid = ckpt quant not loader; bf16 13-shard DiT STREAMS** | act diff: weights/islands/RoPE quant-noise-close to GGUF; residual = community-NVFP4 fidelity §8.12 |
