...
| GLM-5.3-Flash GGUF | `GLM-5.3-Flash-UD-Q2_K_XL-0000{1..4}-of-00004.gguf` | 108,720,071,427 bytes total (101.2535 GiB) | `unsloth/GLM-5.3-Flash-GGUF` @ `d425e572fb9686125831f476129e51cea34bc5b4`, staged 2026-08-28 | the four shard sizes and the 108,720,071,427-byte total were MEASURED here on 2026-08-29; the per-shard sha256 verification and the `mmproj-BF16.gguf` sha256 `513c9bfc55898998186543caefc01626fb28e378b92f391018e1c3dd6655b113` are INHERITED from the staging run recorded on [#2178](https://github.com/mudler/vllm.cpp/issues/2178) and were not recomputed for this row | **Every arm refused.** The production loader (`LoadedEngine::FromModelDir`) opens the file, resolves `general.architecture = glm5next`, walks the 4-way split, and refuses at `blk.3.ffn_gate_exps.weight has unknown ggml type id 17` (IQ2_XS). Measured 2026-08-29 under W5 ([#2223](https://github.com/mudler/vllm.cpp/issues/2223)) | **This row said "none exists" until 2026-08-29 and that is now false**, so the correction is the point of it. What is still true is that no arm here is LOADABLE: a header census over all four shards reads F32 638, Q8_0 346, Q2_K 2, Q3_K 1, Q4_K 1, Q5_K 181, Q6_K 117, IQ2_XS 82, IQ3_XXS 41, IQ4_XS 3 — EIGHT ggml encodings, of which six are undecodable in this tree (Q3_K/Q4_K/Q5_K per O8, IQ2_XS/IQ3_XXS/IQ4_XS per O5). **"Q2_K" in the arm name is a floor, not a format:** only two tensors in the whole file are Q2_K and the 288 experts are IQ2_XS and IQ3_XXS. The other three repositories named `*-GGUF` — `AtomicChat`, `aj9o9`, `vcruz305` — still contained ZERO `.gguf` files when read 2026-08-26 |
