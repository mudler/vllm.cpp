...
DIVERGENCES(A vLLM vs B llama.cpp) = 4/6
...
| 4 `In 1969, humans first walked on` | DIVERGE | 14 | 22486 | 4593 |
| 5 `A prime number is a natural number` | DIVERGE | 32 | 16 | 15 |

DIVERGENCES(C vllm.cpp vs A vLLM) = 4/6

VLLM_vs_LLAMACPP_DIVERGENCES=4/6
VLLMCPP_vs_LLAMACPP_DIVERGENCES=3/6
VLLMCPP_vs_VLLM_DIVERGENCES=4/6
