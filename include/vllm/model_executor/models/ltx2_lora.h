...
// own fixture. No tolerance-based gate could report that, which is why
// `test_ltx2_lora`'s N-adapter case asserts a golden generated by EXECUTING
// `aggregate_lora_products` at the pin and asserts that the wrong form is
// separated from it.
//
