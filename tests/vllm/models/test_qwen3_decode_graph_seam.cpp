...
// THE TWO SWAPPED SEAMS live in the shared harness, because W3 (#1291) added
// three more gates of this exact shape and a fourth copy of them would
// reproduce inside `tests/` the duplication this row removes from `src/`.
// `decode_graph_seam_harness.h` states what they are and what they cannot see.
