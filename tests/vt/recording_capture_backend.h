...
//
// THE HARNESS ADAPTATION, stated once. Every class in SGLang's BCG suite
...
// a backend that RECORDS the capture call sequence instead. Nothing else about
// the upstream cases is adapted: same break counts, same segment counts, same
// arithmetic chains, same in-place-versus-assign split, same non-copyable
// fallback.
//
